    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-dark bg-dark" role="navigation">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse flex-row-reverse fs-4" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item"><a class="nav-link" href="{{asset('/')}}">查詢資源</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{asset('/collections/')}}">瀏覽資源</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{asset('/setting/')}}">資源網域設定</a></li>
                </ul>
            </div>
        </div>
    </nav>
